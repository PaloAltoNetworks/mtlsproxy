...
domingo_write_versions:
	...
	@apolibver --project-version $(PROJECT_VERSION) --project-sha $(PROJECT_SHA) -o ./internal/versions
...
domingo_package_ca_certificates:
	@echo "packaging trusted ca certificates from mozilla..."
